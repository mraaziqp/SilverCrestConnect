...
const LINKS = [
  ...
  { href: '#programme', label: 'Event Details' },
...
export const Nav: React.FC = () => {
  ...
  // The bar starts transparent over the hero and gains a ground once the page
  // moves, so the hero art is not boxed in at the top.
  useEffect(() => {
    ...
    >
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex items-center justify-between h-[72px]">
          {/* Wordmark */}
          <a href="#top" className="flex items-center gap-3 shrink-0" aria-label={`${EVENT.fullName} home`}>
            <Monogram size={34} />
            <span className="font-display text-[13px] sm:text-[15px] uppercase tracking-brand text-bone font-bold leading-none">
              Silver Crest<span className="hidden sm:inline"> Connect</span>
            </span>
          </a>
